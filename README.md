...
- **Financial Summary**: Track the total value and average price of your collection.
- **Rating Distribution**: Analyze your reading preferences through rating statistics.

## 🛠 Technical Stack

- **Frontend**: Tailwind CSS for a modern, responsive UI.
- **Backend**: Firebase Authentication and Firestore (NoSQL).
- **Icons**: Flaticon & Heroicons.
- **Utilities**:
  - `html5-qrcode` for professional-grade scanning.
  - `PapaParse` for powerful CSV import/export.
  - Google Books & Open Library APIs for metadata.
...
Application created with ❤️ by [Towfik Ahmed](https://github.com/towfikahmed0).

---
*Preserve every word. Every story matters.*
